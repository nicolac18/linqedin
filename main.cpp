...
//   string s= "/Users/Nicola/QtCreator/LinQedIn/db.xml";
   ...
   p1.aggiungiEsperienzaProfessionale(EsperienzaProfessionale(QDate(2010, 6, 1), QDate(2010, 9, 30), "musei civici"));
